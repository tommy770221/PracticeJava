...
public class OpratorDemo3 {
    ...
    public static void main(String[] args) {
         ...
         */
         ...
         /*
          0000 0000 0000 0000 0000 0000 1000 0000 (補)
          0000 0000 0000 0000 0000 0000 1000 0001 (補)
          --------------------------------------------------
        ...
        System.out.println("-16 右移 3 = "+(-16>>3) );

        System.out.println("-2 無符右移 3 = "+(-2>>>3) );
        System.out.println("-16 無符右移 3 = "+(-16>>>3) );
